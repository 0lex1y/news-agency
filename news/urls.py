...
urlpatterns = [
    ...
    path("topics/",
         ...
         name="topics_list"),
    path("topics/create/",
         TopicsCreateView.as_view(),
         name="topics_create"),
    path("topics/<int:pk>/update/",
         TopicsUpdateView.as_view(), name="topics_update"),
    path("topics/<int:pk>/delete/",
         TopicsDeleteView.as_view(), name="topics_delete"),
    path("topics/<int:pk>/detail/",
         TopicsDetailView.as_view(),
         name="topics_detail"),
    # Redactors
    path("redactors/",
    ...
    path("redactors/create/",
         ...
         name="redactors_create"),
    path(
        "redactors/<int:pk>/update/",
        RedactorsUpdateView.as_view(),
        name="redactors_update",
    ),
    path(
        "redactors/<int:pk>/delete/",
        RedactorsDeleteView.as_view(),
        name="redactors_delete",
    ),
    path(
        "redactors/<int:pk>/detail/",
        RedactorsDetailView.as_view(),
        name="redactors_detail",
    ),
]
